      ...
      <div className="promotions mb-8">
        <div className="promotion-wrapper">
          <div className="section-header">
            <h3 className="section-heading">Promotions</h3>
            ...
            <div className="slider-container">
             ...
             <div className="slide-controls">
              <button className="slide-control-outline">
               <IoIosArrowBack className="arrow-outline" onClick={previous}/>
              </button>
              <button className="slide-control-outline">
               <IoIosArrowForward  className="arrow-outline" onClick={next}/> 
              </button>
             </div>
            </div>
              </div>
